...
# function 2 puts the string into a list. then using the pop function on the before List we remove and return the last element of the list and append it too the after List. we loop through the list until all elements have been appended. Adapted from : https://www.tutorialspoint.com/python/list_pop.htm
